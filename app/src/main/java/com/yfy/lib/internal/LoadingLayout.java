...
import com.yfy.lib.ILoadingLayout;
import com.yfy.lib.PullToRefreshBase.Mode;
import com.yfy.lib.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	protected boolean mForRefresh = true;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		if (attrs.hasValue(R.styleable.PullToRefresh_forRefresh)) {
			mForRefresh = attrs.getBoolean(
					R.styleable.PullToRefresh_forRefresh, true);
		}
	...
	public final void hideAllViews() {
		...
		if (View.VISIBLE == mHeaderText.getVisibility() || !mForRefresh) {
			mHeaderText.setVisibility(View.INVISIBLE);
		}
		if (View.VISIBLE == mHeaderProgress.getVisibility() || !mForRefresh) {
			mHeaderProgress.setVisibility(View.INVISIBLE);
		}
		if (View.VISIBLE == mHeaderImage.getVisibility() || !mForRefresh) {
			mHeaderImage.setVisibility(View.INVISIBLE);
		}
		if (View.VISIBLE == mSubHeaderText.getVisibility() || !mForRefresh) {
	...
	public void hideRefreshDrawable() {
		if (isDefined) {
			return;
		}
		if (View.VISIBLE == mHeaderProgress.getVisibility() || !mForRefresh) {
