...
import com.yfy.lib.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		// if (!mListViewExtrasEnabled || !getShowViewWhileRefreshing() || null
...
//	@Override
//	public void setMode(
//			com.yfy.lib.PullToRefreshBase.Mode mode) {
//		super.setMode(mode);
...
//	}
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		if (mListViewExtrasEnabled) {
			...
			LoadingLayout header = defineHeaderLayout(getContext(),
					Mode.PULL_FROM_START, a);
			LoadingLayout footer = defineFooterLayout(getContext(),
					Mode.PULL_FROM_END, a);

			// Create Loading Views ready for use later
			FrameLayout frame = new FrameLayout(getContext());
			mHeaderLoadingView = header == null ? createLoadingLayout(
					getContext(), Mode.PULL_FROM_START, a) : header;
			mHeaderLoadingView.setVisibility(View.GONE);
			frame.addView(mHeaderLoadingView, lp);
			mRefreshableView.addHeaderView(frame, null, false);

			mLvFooterLoadingFrame = new FrameLayout(getContext());
			mFooterLoadingView = footer == null ? createLoadingLayout(
					getContext(), Mode.PULL_FROM_END, a) : footer;
			mFooterLoadingView.setVisibility(View.GONE);
