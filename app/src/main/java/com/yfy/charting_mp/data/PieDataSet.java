...
public class PieDataSet extends com.yfy.charting_mp.data.DataSet<com.yfy.charting_mp.data.Entry> {
    ...
    public PieDataSet(List<com.yfy.charting_mp.data.Entry> yVals, String label) {
        super(yVals, label);
