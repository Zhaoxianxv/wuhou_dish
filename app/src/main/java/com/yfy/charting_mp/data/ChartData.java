 ...
 */
public abstract class ChartData<T extends com.yfy.charting_mp.data.DataSet<? extends com.yfy.charting_mp.data.Entry>> {
    ...
    public void calcMinMax(int start, int end) {
        ...
        if (mDataSets == null || mDataSets.size() < 1) {
            ...
            if (firstLeft != null) {
                ...
                for (com.yfy.charting_mp.data.DataSet<?> dataSet : mDataSets) {
     ...
     */
    public com.yfy.charting_mp.data.Entry getEntryForHighlight(Highlight highlight) {
     ...
     * @param dataSetIndex
     */
    public void addEntry(com.yfy.charting_mp.data.Entry e, int dataSetIndex) {
     ...
     * @param dataSetIndex
     */
    public boolean removeEntry(com.yfy.charting_mp.data.Entry e, int dataSetIndex) {
    ...
    public boolean removeEntry(int xIndex, int dataSetIndex) {
        ...
        com.yfy.charting_mp.data.Entry e = dataSet.getEntryForXIndex(xIndex);
     ...
     * @return
     */
    public T getDataSetForEntry(com.yfy.charting_mp.data.Entry e) {
    ...
    public void setValueFormatter(ValueFormatter f) {
        if (f == null)
            ...
            for (com.yfy.charting_mp.data.DataSet<?> set : mDataSets) {
