...
import com.yfy.charting_mp.utils.DefaultValueFormatter;
 ...
 */
public abstract class DataSet<T extends com.yfy.charting_mp.data.Entry> {
    ...
    protected void calcMinMax(int start, int end) {
        ...
        for (int i = start; i <= endValue; i++) {
            ...
            com.yfy.charting_mp.data.Entry e = mYVals.get(i);
    ...
    public float getYValForXIndex(int xIndex) {
        ...
        com.yfy.charting_mp.data.Entry e = getEntryForXIndex(xIndex);
    ...
    public void addEntry(com.yfy.charting_mp.data.Entry e) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void addEntryOrdered(com.yfy.charting_mp.data.Entry e) {
     ...
     * @return
     */
    public int getEntryPosition(com.yfy.charting_mp.data.Entry e) {
     ...
     * @return
     */
    public boolean contains(com.yfy.charting_mp.data.Entry e) {
