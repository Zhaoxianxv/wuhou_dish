...
package com.yfy.charting_mp.animation;
...
public class ChartAnimator {
     ...
     * @param easingY
     */
    public void animateXY(int durationMillisX, int durationMillisY, com.yfy.charting_mp.animation.Easing.EasingOption easingX,
            com.yfy.charting_mp.animation.Easing.EasingOption easingY) {

        if (android.os.Build.VERSION.SDK_INT < 11)
            return;

        ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", 0f, 1f);
        animatorY.setInterpolator(com.yfy.charting_mp.animation.Easing.getEasingFunctionFromOption(easingY));
        animatorY.setDuration(
                durationMillisY);
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
        animatorX.setInterpolator(com.yfy.charting_mp.animation.Easing.getEasingFunctionFromOption(easingX));
        animatorX.setDuration(
                durationMillisX);
     ...
     * @param easing
     */
    public void animateX(int durationMillis, com.yfy.charting_mp.animation.Easing.EasingOption easing) {

        if (android.os.Build.VERSION.SDK_INT < 11)
            return;

        ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
        animatorX.setInterpolator(com.yfy.charting_mp.animation.Easing.getEasingFunctionFromOption(easing));
        animatorX.setDuration(durationMillis);
        animatorX.addUpdateListener(mListener);
        animatorX.start();
    }
     ...
     * @param easing
     */
    public void animateY(int durationMillis, com.yfy.charting_mp.animation.Easing.EasingOption easing) {
