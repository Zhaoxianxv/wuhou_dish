...
//        Log.e(TAG, "setBadgeCount: " +Build.MANUFACTURER);
        if (Build.MANUFACTURER.equalsIgnoreCase("xiaomi")) {
            ...
            setBadgeOfMeizu(count);
        } else if (Build.MANUFACTURER.toLowerCase().contains("huawei")) {
            setBadgeOfHuawei(count);
        }else{
            Log.e(TAG,"Not Found Support Launcher");
//            Toast.makeText(context, "Not Found Support Launcher", Toast.LENGTH_LONG).show();
     ...
     *
     */
    private static void setBadgeOfHuawei(int count){
        Log.e(TAG,"HUAWEI   "+count);
    }
    /**
     * 设置魅族的BADGE
     */
    private static void setBadgeOfMeizu(int count){
        Log.e(TAG,"Meizu   "+count);
    }
    /**
     * 设置MIUI的Badge
     */
