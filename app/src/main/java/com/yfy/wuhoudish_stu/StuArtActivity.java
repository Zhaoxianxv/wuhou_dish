...
public class StuArtActivity extends BaseActivity implements Callback<ResEnv> {

    private static final String TAG = StuArtActivity.class.getSimpleName();
    private StuArtAdapter adapter;
    ...
    private ArrayList<ArtBean> artBeans=new ArrayList<>();
    private String name;
    private void getData(){
        Intent intent=getIntent();
        name=intent.getStringExtra(Base.name);
        artBeans=intent.getParcelableArrayListExtra(Base.data);
        initSQToolbar(name);
//        getStulist(true);
        adapter.setDataList(artBeans);
...
//        xlist.setLayoutManager(new GridLayoutManager(this, 1));
        ...
        adapter=new StuArtAdapter(mActivity);
