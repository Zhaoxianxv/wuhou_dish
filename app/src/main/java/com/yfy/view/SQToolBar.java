...
public class SQToolBar extends RelativeLayout {
    ...
    public SQToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        MENU_ICON_SIZE = (int) context.getResources().getDimension(R.dimen.app_toolbar_menu_size);
        MENU_ITEM_SIZE = (int) context.getResources().getDimension(R.dimen.app_toolbar_height);
        TEXT_PADDING_LEFT_RIGHT = dip2px(14);

        menus = new ArrayList<>();
        //设置要给默认导航
        setNavi(R.drawable.selector_head_back);
    }
    /**
     * 设置文字导航（左上角文字）
     *
...
//        tv_menu.setBackgroundDrawable(getResources().getDrawable(R.drawable.app_icon_right_btn));
    ...
    private StateListDrawable createSelector() {
        ...
        Resources resources = getContext().getResources();
            ...
            ColorDrawable pressed = new ColorDrawable(resources.getColor(R.color.app_toobar_background_dark));
        bg.addState(new int[]{android.R.attr.state_pressed, android.R.attr.state_enabled}, pressed);
       ColorDrawable normal = new ColorDrawable(resources.getColor(R.color.app_toobar_background));
    ...
    private StateListDrawable createSelectorPic() {
        StateListDrawable bg = new StateListDrawable();
        Resources resources = getContext().getResources();
        Drawable pressed = resources.getDrawable(R.drawable.app_icon_title_bg);
        bg.addState(new int[]{android.R.attr.state_pressed, android.R.attr.state_enabled}, pressed);
        Drawable normal = resources.getDrawable(R.drawable.app_icon_title_bg);
        bg.addState(new int[]{}, normal);
        return bg;
    }
