...
class SmartTabStrip extends LinearLayout {
    ...
    SmartTabStrip(Context context, AttributeSet attrs) {
        ...
        indicatorWidth = a.getLayoutDimension(R.styleable.stl_SmartTabLayout_stl_indicatorWidth, indicatorWidth);
        ...
        drawDecorationAfterTab = a.getBoolean(R.styleable.stl_SmartTabLayout_stl_drawDecorationAfterTab, drawDecorationAfterTab);
        a.recycle();
