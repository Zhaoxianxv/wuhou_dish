...
public class ChildBean implements Parcelable {
    ...
    public ChildBean(String depid, String depname, int childnum, String numSelectnum, int type) {
        this.depid = depid;
        this.depname = depname;
        this.type = type;
        this.allNum = childnum;
        this.numSelectnum = numSelectnum;
    }
    ...
    public ChildBean(String headPic, String phone1, String phone2, String userid, String username, int type, boolean isChick) {
        HeadPic = headPic;
        Phone1 = phone1;
        Phone2 = phone2;
        this.userid = userid;
    ...
    public String getNumSelectnum() {
        return numSelectnum;
    }

    public void setNumSelectnum(String numSelectnum) {
        this.numSelectnum = numSelectnum;
    }
