 ...
 */
@Root(name = TagFinal.ATTENNEW_GET_MAIN_LIST_USER, strict = false)
@Namespace(reference = Base.NAMESPACE)
@Order(elements = {Base.session_key,Base.type,"status",Base.page,Base.size})
public class AttenUserListReq {
    @Namespace(reference = Base.NAMESPACE)
