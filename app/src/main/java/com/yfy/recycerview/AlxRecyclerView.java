...
public class AlxRecyclerView extends RecyclerView {
    ...
    public AlxRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public AlxRecyclerView(Context context, AttributeSet attrs, int defStyle) {
...
//            mProgressBar.setVisibility(VISIBLE);//一直会显示转圈，自动加载更多时使用
     ...
     * @param <T>
     */
    public static abstract class AlxDragRecyclerViewAdapter<T> extends Adapter<ViewHolder> {
