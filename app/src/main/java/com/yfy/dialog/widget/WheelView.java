...
import com.yfy.dialog.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.radius3_e3bg;
	private int wheelForeground = R.drawable.radius3_f;
