package com.yfy.hellocharts.util;
...
public abstract class ChartUtils {
    ...
    public static final int COLOR_VIOLET = Color.rgb(255, 0, 255);
    public static final int COLOR_GREEN = Color.rgb(100, 205, 120);
    public static final int COLOR_ORANGE = Color.rgb(119, 136, 153);
    public static final int COLOR_RED = Color.rgb(0, 206, 209);
    public static final int SEX = Color.rgb(255, 165, 0);
    public static final int SEX7 = Color.rgb(238, 106, 80);
    public static final int SEX8= Color.rgb(32, 178, 170);

    public static final int[] COLORS = new int[]{COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE, COLOR_RED,SEX,SEX7,SEX8};
