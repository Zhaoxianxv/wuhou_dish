package com.yfy.hellocharts.renderer;
...
public abstract class AbstractChartRenderer implements ChartRenderer {
    ...
    protected void drawLabelTextAndBackground(Canvas canvas, char[] labelBuffer, int startIndex, int numChars, int autoBackgroundColor) {
        ...
        canvas.drawText(labelBuffer, startIndex, numChars, textX, textY, labelPaint);//原方法

    }

    protected void drawLabelTextAndBackground(Canvas canvas,String name, int autoBackgroundColor) {
        final float textX;
        final float textY;
        if (isValueLabelBackgroundEnabled) {
        ...
        canvas.drawText(name, textX, textY, labelPaint);
