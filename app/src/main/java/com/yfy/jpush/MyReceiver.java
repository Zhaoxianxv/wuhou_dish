...
//				context.startActivity(i);
//			}
//			if (type.equals("thflow1")){
//
//				Intent i = new Intent(context, AppliedProjectMainActivity.class);
//                i.putExtra(TagFinal.ID_TAG,"1");
//				i.putExtras(bundle);
//				i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//				context.startActivity(i);
//			}
//			if (type.equals("thflow2")){
////				Log.e("zxx","推送 pkgName  "+pkgName);
//				Intent i = new Intent(context, AppliedProjectMainActivity.class);
//                i.putExtra(TagFinal.ID_TAG,"2");
//				i.putExtras(bundle);
//				i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
//				context.startActivity(i);
//			}
